...
// This text file is to declare the default variables, such as huron_typename, BUILD menu units, vehicles and objects and enemy spawn lists.
...
if ( isNil "huron_typename" ) then { huron_typename = "B_Heli_Transport_03_F"; };
...
if ( isNil "opfor_ammobox_transport" ) then { opfor_ammobox_transport = "O_T_Truck_03_transport_ghex_F"; };
if ( isNil "commander_classname" ) then { commander_classname = "B_T_Officer_F"; };
if ( isNil "crewman_classname" ) then { crewman_classname = "B_T_Crew_F"; };
if ( isNil "pilot_classname" ) then { pilot_classname = "B_T_Helipilot_F"; };
...
support_vehicles = [
	[Arsenal_typename,10,0,0],							//Arsenal_Box
	...
	[Respawn_truck_typename,20,0,5],					//HEMTT_Medical
...
/*	//CSAT(Pacific)	
	"O_T_Soldier_TL_F",									//Team_Leader
	"O_T_Soldier_SL_F",									//Squad_Leader
