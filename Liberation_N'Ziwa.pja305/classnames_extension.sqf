// This file allows you to add content to the mission without conflict issues after each update.
...
FOB_typename = nil;									// Default: "Land_Cargo_HQ_V4_F"
FOB_box_typename = nil;								// Default: "B_Slingload_01_Cargo_F"
FOB_truck_typename = nil;							// Default: "B_T_Truck_01_box_F"
Arsenal_typename = nil;								// Default: "B_supplyCrate_F"
Respawn_truck_typename = nil;						// Default: "B_T_Truck_01_medical_F"
huron_typename = nil;								// Default: "B_Heli_Transport_03_F"				// Change this to swap the Huron for a modded vehicle, like the CUP Chinook.
ammobox_b_typename = nil;							// Default: "Box_NATO_AmmoVeh_F"
ammobox_o_typename = nil;							// Default: "Box_East_AmmoVeh_F"
opfor_ammobox_transport = nil;						// Default: "O_T_Truck_03_transport_ghex_F"		// Make sure this thing can transport ammo boxes (see box_transport_config down below) otherwise things will break.
commander_classname = nil;							// Default: "B_T_Officer_F"
crewman_classname = nil;							// Default: "B_T_Crew_F"
pilot_classname = nil;								// Default: "B_T_Helipilot_F"

// *** FRIENDLIES ***

// Each array below represents one page of the build menu.
// Format: ["classname", manpower, ammo, fuel]. Example: ["B_T_APC_Tracked_01_AA_F", 0, 40, 15].
...
air_vehicles_extension = [
	["JS_JC_FA18E",0,350,50],						//FA18E
	["JS_JC_FA18F",0,350,50]						//FA18F
];
...
// If you want to use a different high_intensity squad like say, Spetznaz, then don't change the 'opfor_vipertl =' part, otherwise you'll have more to change..
opfor_vipertl = nil;
opfor_viperop = nil;
opfor_viperri = nil;
opfor_viperma = nil;
...
// Example: [ "O_T_Truck_03_transport_ghex_F", -6.5, [0,	-0.8,	0.4], [0,	-2.4,	0.4], [0,	-4.0,	0.4] ] = HEMTT_Transport with option to carry 3 ammo boxes.
