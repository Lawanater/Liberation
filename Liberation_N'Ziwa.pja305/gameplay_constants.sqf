GRLIB_save_key = "GREUH_LIBERATION_SAVEGAME_TANOA";	// Change this value if you want different savegames on different map.
...
GRLIB_secondary_missions_costs = [ 15, 12, 10 ];
